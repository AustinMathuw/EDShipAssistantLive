...
namespace PubnubWindowsStore
{
    ...
    public sealed partial class PubnubOperation : Page
    {
        ...
        static Pubnub pubnubToAlexa = null;
        static Pubnub pubnubFromAlexa = null;
    ...
    protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (data != null)
            {
                pubnubToAlexa = new Pubnub("pub-c-06cf8ccb-5bf9-4a97-aca2-3a5eb322dd92", "sub-c-2955e8f4-c6c7-11e6-b8a7-0619f8945a4f", "", "", true); //Initialize PubNub
                pubnubToAlexa.EnableResumeOnReconnect = true;
                pubnubFromAlexa = new Pubnub("pub-c-18a081e9-f557-4146-b7d3-7847a67dfbaa", "sub-c-367dd992-c6c7-11e6-8164-0619f8945a4f", "", "", true); //Initialize PubNub
            ...
            while (true)
            {
                ...
                if (milliseconds - lastUpdate > 5)
                {
                    ...
                    try
                    {
                        ...
                        {
                            pubnubToAlexa.Publish<string>(publishChannel, publishMsg, storeInHistory, PubnubPublishCallbackResult, PubnubDisplayErrorMessage);
        ...
        void PubnubCleanup()
        {
            if (pubnubToAlexa != null)
            {
                pubnubToAlexa.EndPendingRequests();
                pubnubToAlexa = null;
            }
            if (pubnubFromAlexa != null)
            {
                pubnubFromAlexa.EndPendingRequests();
                pubnubFromAlexa = null;
            }
        }
